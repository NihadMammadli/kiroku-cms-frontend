...
import { Button, Table } from "../../components/restyled";
import {
...
const GroupGrades = ({ groupId }: GroupGradesProps) => {
	...
	const {
		...
		isLoading,
		error,
	} = useGradingSyllabusByCourseGroupQuery(groupId);
	...
	const handleEdit = () => {
		...
		messageApi.info(
			"Sillabus bölməsinə keçərək meyarları dəyişdirə bilərsiniz",
		);
	};
						...
						<div>
							...
							>
								<Descriptions.Item label="Kurs">
									{gradeReport.course_name}
								</Descriptions.Item>
								<Descriptions.Item label="Qrup">
									{gradeReport.course_group_name}
								</Descriptions.Item>
								...
								<Descriptions.Item label="Qiymətləndirilmiş çəki">
									<Progress
										...
										status={
											gradeReport.total_weight_graded === 100
												? "success"
												: "active"
										}
									/>
				...
				<Space direction="vertical" size="large" style={{ width: "100%" }}>
					<div>
						...
						<p style={{ color: "#666", margin: "8px 0 0 0" }}>
							Qrupun qiymətləndirmə meyarlarını və tələbə nəticələrini idarə
							edin. Yeni meyar yaratmaq üçün Sillabus bölməsinə keçin.
						</p>
					</div>
						...
						<Empty
							...
							description={
								<div>
									...
									<p>
										Bu qrup üçün qiymətləndirmə sistemi yaratmaq üçün Sillabus
										bölməsinə keçin.
									</p>
								</div>
							}
